...
console.log(color('\n🐶 IG ID: asashi_kunn ','silver'))
console.log(color('🐶 GITHUB: SungMin','silver'))
...
console.log(color('  🦄Xeon Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/918822469980'))
    ...
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['follow: SungMin','Safari','1.0.0'],
        auth: state,
        version
    })
